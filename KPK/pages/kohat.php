...
<head>
    ...
    <!-- SEO Optimization -->
    <title>Army Dog Center Kohat | 03003006220</title>
...
>>>>>>> origin/service_pages
  <head>
    ...
    <!-- SEO Optimization -->
    <title>Army Dog Center KOHAT | 03332874135</title>
    <meta
      name="description"
...
<<<<<<< HEAD
<<<<<<< HEAD
    <meta property="og:title" content="Army Dog Center Kohat | 03003006220" />
    <meta property="og:description" content="        
             چوری، ڈکیتی، قتل اور اغوا جیسے جرائم کے خلاف فوری مدد کے لیے ہمہ وقت دستیاب۔ ہمارے ماہر کتے جرائم کے نشانات ڈھونڈنے اور اہم شواہد فراہم کرنے میں مددگار ثابت ہوتے ہیں۔ ہم 24/7 ہر جگہ خدمات فراہم کرتے ہیں تاکہ آپ کو مکمل تحفظ اور اطمینان حاصل ہو۔
             
            ">
    <meta property="og:url" content="https://services.armydogcenter.org.pk/kohat.php" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://armydogcenter.org.pk/images/services/kpk/kohat.jpeg" />
    <meta property="og:site_name" content="Army Dog Center Pakistan" />
    <meta name="twitter:description" content="        
             چوری، ڈکیتی، قتل اور اغوا جیسے جرائم کے خلاف فوری مدد کے لیے ہمہ وقت دستیاب۔ ہمارے ماہر کتے جرائم کے نشانات ڈھونڈنے اور اہم شواہد فراہم کرنے میں مددگار ثابت ہوتے ہیں۔ ہم 24/7 ہر جگہ خدمات فراہم کرتے ہیں تاکہ آپ کو مکمل تحفظ اور اطمینان حاصل ہو۔
             
            ">
    <meta name="twitter:image" content="https://armydogcenter.org.pk/images/services/kpk/kohat.jpeg" />
    ...
    <link rel="canonical" href="https://services.armydogcenter.org.pk/kohat.php" />
=======
=======
>>>>>>> origin/service_pages
    <meta
      property="og:title"
      content="Army Dog Center KOHAT | 03332874135"
    />
    <meta
    ...
    <meta
      property="og:url"
      content="https://services.armydogcenter.net.pk/kohat.php"
    />
    <meta property="og:type" content="website" />
    <meta
      property="og:image"
    ...
    <link
      rel="canonical"
      href="https://services.armydogcenter.net.pk/kohat.php"
    />
<<<<<<< HEAD
>>>>>>> origin/service_pages
=======
...
<<<<<<< HEAD
    {
        ...
        "@graph":[
            ...
            {
                "@type":"WebPage",
                "@id":"https://services.armydogcenter.org.pk/kohat.php#webpage",
                "url":"https://services.armydogcenter.org.pk/kohat.php",
                "name":"Army Dog Center Kohat",
                "description":"Professional dog services in Kohat including crime investigation, evidence detection, and security services with trained dogs available 24/7.",
        ...
        "@graph": [
          {
            "@type": "WebSite",
            "name": "Army Dog Center KOHAT",
            "url": "https://services.armydogcenter.net.pk/kohat.php",
            "potentialAction": {
              "@type": "SearchAction",
              "target": "https://services.armydogcenter.net.pk/kohat.php",
              "query-input": "required name=armydogcenter"
            }
          },
          {
            "@type": "WebPage",
            "@id": "https://services.armydogcenter.net.pk/kohat.php#webpage",
            "url": "https://services.armydogcenter.net.pk/kohat.php",
            "name": "Army Dog Center KOHAT",
            "description": "We provide professional dog services in KOHAT including crime investigation, evidence detection, and security services with trained dogs available 24/7.",
  ...
  <body class="bg-gray-50 font-sans">
    ...
    >
      <div class="container mx-auto">
        ...
        <h2 class="text-3xl md:text-4xl font-semibold">
<<<<<<< HEAD
          KOHAT <br> 03003406220
        </h2>
      </div>
>>>>>>> origin/service_pages
=======
          KOHAT <br> 03332874135
        </h2>
      </div>
>>>>>>> origin/service_pages
    </header>
            ...
            <div class="bg-white p-2 rounded-xl shadow-md">
                ...
                <div class="flex justify-center">
                    <div
                        ...
                        <img src="https://armydogcenter.org.pk/images/services/kpk/kohat.jpeg" alt="German Shepherd Dog"
                        ...
                        <div
                            ...
                            <h4 class="text-xl font-bold">German Shepherd Dog - Kohat</h4>
                            <p class="text-sm">
                                Our highly trained dogs are experts in detection and tracking in Kohat
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-teal-500 to-teal-300 py-4 px-6">
                    <h3 class="text-white text-center text-2xl font-bold">
                        Our Professional Services in Kohat
                    </h3>
                </div>
        ...
        <div data-aos="fade-up" class="mb-10">
            <div class="bg-gradient-to-r from-teal-500 to-teal-300 rounded-xl p-8 shadow-lg text-center">
                <h3 class="text-white text-2xl font-bold mb-4">
                    Need Professional Dog Services in Kohat?
                </h3>
                <p class="text-cyan-100 mb-6 max-w-lg mx-auto">
                    Our team is available 24/7 to assist with any emergency situation in Kohat.
...
>>>>>>> origin/service_pages
      ...
      >
        ...
        <p class="text-gray-700 font-medium">
          We at Army Dog Center KOHAT are ready to serve you 24/7. Contact us
      ...
      <div data-aos="fade-up" class="mb-10">
        <div class="bg-white p-2 rounded-xl shadow-md">
          ...
          <div class="flex justify-center">
            ...
            >
              <img
                src="https://www.armydogcenter.net.pk/images/services/kpk/kohat.jpeg"
