...
<head>
    ...
    <!-- SEO Optimization -->
    <title>Army Dog Center Nowshera | 03008977885</title>
...
=======
  <head>
    ...
    <!-- SEO Optimization -->
    <title>Army Dog Center NOWSHERA | 03003406220</title>
    <meta
      name="description"
...
<<<<<<< HEAD
    <meta property="og:title" content="Army Dog Center Nowshera | 03008977885" />
    <meta property="og:description" content="        
             چوری، ڈکیتی، قتل اور اغوا جیسے جرائم کے خلاف فوری مدد کے لیے ہمہ وقت دستیاب۔ ہمارے ماہر کتے جرائم کے نشانات ڈھونڈنے اور اہم شواہد فراہم کرنے میں مددگار ثابت ہوتے ہیں۔ ہم 24/7 ہر جگہ خدمات فراہم کرتے ہیں تاکہ آپ کو مکمل تحفظ اور اطمینان حاصل ہو۔
             
            ">
    <meta property="og:url" content="https://services.armydogcenter.org.pk/nowshera.php" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://armydogcenter.org.pk/images/services/kpk/nowshera.jpeg" />
    <meta property="og:site_name" content="Army Dog Center Pakistan" />
    <meta name="twitter:description" content="        
             چوری، ڈکیتی، قتل اور اغوا جیسے جرائم کے خلاف فوری مدد کے لیے ہمہ وقت دستیاب۔ ہمارے ماہر کتے جرائم کے نشانات ڈھونڈنے اور اہم شواہد فراہم کرنے میں مددگار ثابت ہوتے ہیں۔ ہم 24/7 ہر جگہ خدمات فراہم کرتے ہیں تاکہ آپ کو مکمل تحفظ اور اطمینان حاصل ہو۔
             
            ">
    <meta name="twitter:image" content="https://armydogcenter.org.pk/images/services/kpk/nowshera.jpeg" />
    ...
    <link rel="canonical" href="https://services.armydogcenter.org.pk/nowshera.php" />
=======
    <meta
      property="og:title"
      content="Army Dog Center NOWSHERA | 03003406220"
    />
    <meta
    ...
    <meta
      property="og:url"
      content="https://services.armydogcenter.net.pk/nowshera.php"
    />
    <meta property="og:type" content="website" />
    <meta
      property="og:image"
    ...
    <link
      rel="canonical"
      href="https://services.armydogcenter.net.pk/nowshera.php"
    />
>>>>>>> origin/service_pages
...
<<<<<<< HEAD
    {
        ...
        "@graph":[
            ...
            {
                "@type":"WebPage",
                "@id":"https://services.armydogcenter.org.pk/nowshera.php#webpage",
                "url":"https://services.armydogcenter.org.pk/nowshera.php",
                "name":"Army Dog Center Nowshera",
                "description":"Professional dog services in Nowshera including crime investigation, evidence detection, and security services with trained dogs available 24/7.",
    ...
    <header class=" text-white p-8 text-center shadow-lg h-[35vh] flex items-center justify-center"
        ...
        <div class="container mx-auto">
            ...
            <h2 class="text-3xl md:text-4xl font-semibold">
              <b>Nowshera</b> <br> <b>03008977885</b>
            </h2>
        </div>
=======
      {
        ...
        "@graph": [
          {
            "@type": "WebSite",
            "name": "Army Dog Center NOWSHERA",
            "url": "https://services.armydogcenter.net.pk/nowshera.php",
            "potentialAction": {
              "@type": "SearchAction",
              "target": "https://services.armydogcenter.net.pk/nowshera.php",
              "query-input": "required name=armydogcenter"
            }
          },
          {
            "@type": "WebPage",
            "@id": "https://services.armydogcenter.net.pk/nowshera.php#webpage",
            "url": "https://services.armydogcenter.net.pk/nowshera.php",
            "name": "Army Dog Center NOWSHERA",
            "description": "We provide professional dog services in NOWSHERA including crime investigation, evidence detection, and security services with trained dogs available 24/7.",
            ...
            <div class="bg-white p-2 rounded-xl shadow-md">
                ...
                <div class="flex justify-center">
                    <div
                        ...
                        <img src="https://armydogcenter.org.pk/images/services/kpk/nowshera.jpeg" alt="German Shepherd Dog"
                        ...
                        <div
                            ...
                            <h4 class="text-xl font-bold">German Shepherd Dog - Nowshera</h4>
                            <p class="text-sm">
                                Our highly trained dogs are experts in detection and tracking in Nowshera
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-teal-500 to-teal-300 py-4 px-6">
                    <h3 class="text-white text-center text-2xl font-bold">
                        Our Professional Services in Nowshera
                    </h3>
                </div>
        ...
        <div data-aos="fade-up" class="mb-10">
            <div class="bg-gradient-to-r from-teal-500 to-teal-300 rounded-xl p-8 shadow-lg text-center">
                <h3 class="text-white text-2xl font-bold mb-4">
                    Need Professional Dog Services in Nowshera?
                </h3>
                <p class="text-cyan-100 mb-6 max-w-lg mx-auto">
                    Our team is available 24/7 to assist with any emergency situation in Nowshera.
...
=======
      ...
      >
        ...
        <p class="text-gray-700 font-medium">
          We at Army Dog Center NOWSHERA are ready to serve you 24/7. Contact us
      ...
      <div data-aos="fade-up" class="mb-10">
        <div class="bg-white p-2 rounded-xl shadow-md">
          ...
          <div class="flex justify-center">
            ...
            >
              <img
                src="https://www.armydogcenter.net.pk/images/services/kpk/nowshera.jpeg"
